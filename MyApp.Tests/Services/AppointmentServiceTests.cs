...
public class AppointmentServiceTest
{
    ...
    // Consolidated seeder for reusable, consistent test data
    private async Task SeedStandardDataAsync(ApplicationDbContext db, bool isDoctorActive = true)
    {
        ...
        var user = new UserEntity { Id = 1, Name = "Dr. Test", PasswordHash = "dummy_hash", Role = UserRole.Doctor };
        ...
        // Fixed time for reliable assertions
        var appointmentTime = new DateTime(2026, 1, 1, 10, 0, 0, DateTimeKind.Utc);

        var appointment1 = new AppointmentsEntity { Id = 1, Status = AppointmentStatus.Scheduled, DoctorId = 1, PatientId = 1, TimeOfAppointment = appointmentTime, CreatedAt = appointmentTime, CreatedByTheFrontDeskId = 1 };
        var appointment2 = new AppointmentsEntity { Id = 2, Status = AppointmentStatus.Completed, DoctorId = 1, PatientId = 2, TimeOfAppointment = appointmentTime, CreatedAt = appointmentTime, CreatedByTheFrontDeskId = 1 };
        var appointment3 = new AppointmentsEntity { Id = 3, Status = AppointmentStatus.Cancelled, DoctorId = 1, PatientId = 3, TimeOfAppointment = appointmentTime, CreatedAt = appointmentTime, CreatedByTheFrontDeskId = 1 };
